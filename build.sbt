...
lazy val schemaSqlString = inputKey[Unit]("Prints schema sql string for (space-delimited) table name(s)")
...
lazy val commonSettings = Seq(
  ...
  libraryDependencies ++= swaggerDeps,
...
lazy val webapp = (project in file("."))
  ...
  .settings(
    ...
    schemaSqlString := mojozPrintSchemaSql.evaluated,
